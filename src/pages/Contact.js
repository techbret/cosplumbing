        ...
        <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="max-w-lg mx-auto">
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              Whatever the job, we can get it done!
            </p>
            <dl className="mt-8 text-base text-gray-500">
              ...
              <div className="mt-6">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">+1 (719) 640-4875</span>
                </dd>
              </div>
              <div className="mt-3">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">cosplumbing14@gmail.com</span>
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="max-w-lg mx-auto lg:max-w-none">
            <form action="#" method="POST" className="grid grid-cols-1 gap-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-sky-400 hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500"
                >
                  Submit
                </button>
              </div>
